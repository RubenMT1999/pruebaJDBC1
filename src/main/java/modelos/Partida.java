...
public class Partida {
    ...
    public Partida(String codigo, double server, Map<Jugador, Personaje> elecciones,
                   Map<Integer, Set<Jugador>> jugadoresPorEquipo, LocalDateTime inicioPartida, LocalDateTime finPartida,
                   int duracionPartida, Integer equipoVencedor) {
        this.codigo = codigo;
        this.server = server;
    ...
    public Partida(Partida partida){
        this.codigo = partida.codigo;
        this.server = partida.server;
        this.elecciones = partida.elecciones;
        this.jugadoresPorEquipo = partida.jugadoresPorEquipo;
        this.inicioPartida = partida.inicioPartida;
        this.finPartida = partida.finPartida;
        this.duracionPartida = partida.duracionPartida;
        this.equipoVencedor = partida.equipoVencedor;
        this.id= ++idSiguiente;
    }
